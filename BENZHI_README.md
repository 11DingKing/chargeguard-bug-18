...
- 项目：11DingKing/chargeguard-bug-18
...
./build_benzhi_docker.sh benzhi-task-56-amd64 linux/amd64
./build_benzhi_docker.sh benzhi-task-56-arm64 linux/arm64
docker run -it benzhi-task-56-amd64:latest
docker run -it --platform linux/arm64 benzhi-task-56-arm64:latest
```
